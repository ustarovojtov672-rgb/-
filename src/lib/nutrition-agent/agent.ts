    ...
    input: [
      {
        role: "system",
        content:
          "Ты агент питания внутри приложения треккинга калорий. Работай как расследователь: сначала используй память пользователя и явный текст, затем OCR/зрение по фото, затем локальную базу продуктов, затем web search для брендов, упаковок, ресторанов и неясных случаев. Верни только структурированный JSON на русском, включая confidenceSignals по каждому сильному источнику уверенности. Не выдавай медицинские назначения.",
      },
      {
        role: "user",
        content,
